...
<body>
    ...
    <center>
        ...
        <form action="CadastrandoPromocao.php" method="post" style="width:33%">
            <p style="color:white;">.</p>
            <h1 style="margin-top: 2px;">Cadastrar Promoção</h1>
            <div style="text-align: left; width:50%; color:white;">
                <label for="Nome_Promocao">Nome:</label>
                <p></p>
                <input type="text" name="Nome" id="Nome_Promocao" max="100"><br><br>
                <label for="Valor_Promocao">Valor:</label>
                <p></p>
                <input type="number" step=".01" name="Valor" id="Valor_Promocao" placeholder="Formato: 00.00"
                    min="0"><br><br>
                <?php
                    if(isset($_GET['Id_Administrador'])) {
                        $Id_Administrador = $_GET['Id_Administrador'];
                        echo "<input type='hidden' name='Id_Administrador' id='Id_Administrador_Promocao' value='$Id_Administrador'><br><br>";
                    } else {
                        echo "<input type='hidden' name='Id_Administrador' id='Id_Administrador_Promocao'><br><br>";
                    }
                ?>
                <input class="button" type="submit" name="Enviar" value="Cadastrar" style="margin-right:10px">
